...
## 📷 INTERCEPTED EVIDENCE: The Mid-Journey Photo

**Scenario:** Along with the ticket, we intercepted a photograph (`clues/clue on road.jpeg`) snapped by our target from the bus window midway through their trip. On the surface, it’s just a passing view. But if you know how to look *beneath* the surface of a digital file, you might uncover the exact breadcrumbs needed to track their route to the final testing center. 

---
## Submit your intel based answers [here](https://tally.so/r/ODzy6K)

---

## 🔐 OFFICIAL INVESTIGATION HINTS

Hints will be published later. However, if you are stuck and need them urgently, please **raise an issue** in this repository.
